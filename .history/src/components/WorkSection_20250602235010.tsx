    ...
    return (
        <section id="work" className="bg-slate-100 rounded-lg py-20">
            <div className="max-w-6xl mx-auto px-6 text-black">
                ...
                <a className="text-xl mb-6">This collection is a work in progress with new content added weekly (if not more), I hope if you've made it this far then you make a habit of doing so. </a>
