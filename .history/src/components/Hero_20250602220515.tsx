...
export default function Hero() {
  ...
  return (
    <div className="flex flex-col items-center justify-center w-full bg-slate-600">
      ...
      <div className="bg-slate-500 p-4 rounded-md mt-8 mb-2 flex flex-col md:flex-row items-center gap-4">
        {/* Responsive logos */}
        <div className="text-center md:text-left px-4 py-4 rounded-md">
          {/* Large logo for desktop */}
          <img
            src="/assets/logo-lg-white.png"
            alt="Dom Caracappa | TECH WRITER"
            className="hidden md:block w-auto max-w-xs mx-auto md:mx-0"
          />
