...
html_theme_options = {
    "light_logo": "logo-dark.png",  # Black logo for light background
    "dark_logo": "logo-light.png",  # White logo for dark background
}
...
html_theme = 'furo'       # Choose your theme, e.g., 'alabaster', 'sphinx_rtd_theme'
