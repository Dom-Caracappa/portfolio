...
| 2    | Select the operating system:<br>**Raspberry Pi OS Lite (32-bit)**.<br>This version does not include a graphical desktop.                                                                                           |
| 3    | Select the SD card you want to flash.<br>Double-check it's the correct drive.                                                                                                                                      |
| 4    | Click the gear icon to open **Advanced Settings**:<br>- Enable SSH<br>- Set hostname (e.g., `ourpi.local`)<br>- Configure Wi-Fi credentials and region<br>- Set username and password<br>- Set locale and timezone |
| 5    | Click **Save**, then **Write** to begin flashing the SD card.                                                                                                                                                      |
