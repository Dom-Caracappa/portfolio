...
Follow the steps below to choose the correct Raspberry Pi OS Lite version in the Imager.

<div style="display: flex; gap: 1rem; flex-wrap: wrap; align-items: flex-start;">

[![Step 1: Click OS (Other)](..assets/imager_OS_1.png)](assets/imager_OS_1.png "Step 1"){ data-lightbox="os-selection" style="width: 300px;" }

[![Step 2: Choose OS Lite](..assets/imager_OS_2.png)](assets/imager_OS_2.png "Step 2"){ data-lightbox="os-selection" style="width: 300px;" }
